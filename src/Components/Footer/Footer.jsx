      ...
      <div className='mx-auto w-full max-w-7xl px-8'>
        <div className='mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-4'>
          ...
          <div className='w-full space-y-5'>
            <img src={PMLogo} alt='footer logo' className='w-32 rounded-full' />
            <p className='text-justify'>
              Elevate every event with our expertise. From conception to
              execution, we craft memorable experiences tailored to your vision.
        ...
        <div className='flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between'>
          ...
          >
            &copy; {currentYear} <a href='#'>SNOW Event Management</a>. All
            Rights Reserved.
          </Typography>
